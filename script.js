...
function generateAPI() {
    var apiURL = "https://api.openweathermap.org/data/2.5/weather?q=" + $(".locationInput").val() + "&appid=" + apiKey + "&units=imperial"
    fetch(apiURL)
    .then(function(response){
        return response.json()
    })
    .then(function (data) {
        ...
        $(".cityIcon").text(data.weather[0].icon);      
    })
}
